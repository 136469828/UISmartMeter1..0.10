...
@synthesize _items,_selectedStainView,arrowSize;
...
- (void)commonInit
{
    ...
    //((CAShapeLayer *)self.layer).fillColor = [UIColor grayColor].CGColor;
    
    ((CAShapeLayer *)self.layer).fillColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"navbar_background.png"]].CGColor;
    
    //[[UIColor alloc] initWithPatternImage:[UIImage imageNamed:@"navbar_background.png"]];
    ...
    self._selectedStainView.backgroundColor = [UIColor orangeColor];
}
...
- (void)insertSegmentWithTitle:(NSString *)title atIndex:(NSUInteger)segment animated:(BOOL)animated
{
    ...
    segmentView.textColor = [UIColor blackColor];
...
- (void)setArrowSize:(CGFloat)arrowSizes
{
