...
#define CANCEL_BUTTON_COLOR                     [UIColor colorWithRed:136/255.00f green:136/255.00f blue:136/255.00f alpha:1]
...
#define OTHER_BUTTON_COLOR                      [UIColor colorWithRed:119.0/255.0 green:198.0/255.0 blue:57.0/255.0 alpha:1.0]
...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructionButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitlesArray
{
    ...
    self.backGroundView.backgroundColor = [UIColor colorWithRed:241.0/255.0 green:241.0/255.0 blue:241.0/255.0 alpha:1.0];
...
{
    UILabel *titlelabel = [[UILabel alloc] initWithFrame:CGRectMake(30, TITLE_INTERVAL_HEIGHT, [UIApplication sharedApplication].keyWindow.frame.size.width-60, TITLE_HEIGHT)];
    titlelabel.backgroundColor = [UIColor clearColor];
    titlelabel.textAlignment = kUITextAlignmentCenter;
...
{
    UIButton *destructiveButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, self.frame.size.width-BUTTON_INTERVAL_WIDTH*2, BUTTON_HEIGHT)];
...
//    destructiveButton.layer.borderColor = BUTTON_BORDER_COLOR;
    ...
    destructiveButton.titleLabel.font = [UIFont systemFontOfSize:15];
...
{
    UIButton *otherButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT + (postionIndex*(BUTTON_HEIGHT+(BUTTON_INTERVAL_HEIGHT/2))), self.frame.size.width-BUTTON_INTERVAL_WIDTH*2, BUTTON_HEIGHT)];
...
{
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, self.frame.size.width-BUTTON_INTERVAL_WIDTH*2, BUTTON_HEIGHT)];
