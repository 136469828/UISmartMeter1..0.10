...
-(void)setupView {
	...
	[self setBackgroundColor:[UIColor colorWithRed:129.0/255.0 green:161.0/255.0 blue:223.0/255.0 alpha:1.0]];
	...
	tickerLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.frame.size.height / 6, self.frame.size.width, self.frame.size.height / 6 * 4)];
